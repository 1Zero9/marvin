...
export default async function HouseholdPage() {
  ...
  return <div className={styles.wrap}>
    ...
    <section className={`card ${styles.members}`}><h2>Health</h2><p className={styles.meta}>Weight, alcohol, workouts, and daily check-ins — private to you.</p><Link href="/health" className="btn btn-secondary">Open Health</Link></section>
