...
type IconName = "home" | "cook" | "log" | "more";
  ...
  return <>
    {links.map((link) => {
      const active = link.href === "/"
        ? pathname === "/"
        : pathname.startsWith(link.href) || (link.href === "/cook" && (pathname.startsWith("/books") || pathname.startsWith("/recipes") || pathname.startsWith("/decide") || pathname.startsWith("/snap")));
